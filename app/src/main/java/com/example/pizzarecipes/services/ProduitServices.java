...
public class ProduitServices implements IDao<Produit> {
    ...
    private static com.example.pizzarecipes.services.ProduitServices INSTANCE;
    ...
    public static com.example.pizzarecipes.services.ProduitServices getInstance() {
        if (INSTANCE == null) INSTANCE = new com.example.pizzarecipes.services.ProduitServices();
        return INSTANCE;
    }
